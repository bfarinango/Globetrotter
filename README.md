...
Deployed Application (optional): [[Globetrotter Deployed Site] (https://bfarinango.github.io/Globetrotter/)
...
<div style="position: relative; padding-bottom: 56.25%; height: 0;"><iframe src="https://www.loom.com/embed/4060476605624223ac48ed7a94edfb91?sid=0b791bc2-1f68-402f-baf7-d7f64976f764" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen style="position: absolute; top: 0; left: 0; width: 100%; height: 100%;"></iframe></div>

### Reflection

* Did the topics discussed in your labs prepare you to complete the assignment? Be specific, which features in your weekly assignment did you feel unprepared to complete?

I felt unprepared to complete the CSS portion of the project. I had a lot of trouble with the Flex features, but I was provided with resources that ultimately helped me understand everything.

* If you had more time, what would you have done differently? Would you have added additional features? Changed the way your project responded to a particular event, etc.
  
I would have improved the UI/UX of the pages and implemented a map feature that shows the pinned locations of each place.

* Reflect on your project demo, what went well? Were there things that maybe didn't go as planned? Did you notice something that your peer did that you would like to try next time?

I think my overall design choices, like the color palette and hover features, went well. Everything went as planned, but I probably would spend more time talking about each unique feature I implemented. One of my peers implemented a song into their web page, and it's something 
I would love to learn how to do.

### Shout out

Shout out to Luccia for helping me with the CSS portion of the project!
